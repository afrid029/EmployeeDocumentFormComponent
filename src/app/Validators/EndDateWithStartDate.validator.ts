...
export function EndDateWithStartDate(control : AbstractControl) : ValidationErrors | null {
    ...
    if(endDate && startDate ) {
        ...
        if(diffInMonths < 1) {
            return ({
                MinimumGapBetweenEndDateStarDate : 'The gap between End date and Start Date should for Employment is minimum 1 month'
            })
        }
